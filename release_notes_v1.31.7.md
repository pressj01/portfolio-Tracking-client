## v1.31.7 - Cumulative Desktop Release Since v1.29.0

**Release date:** June 2, 2026
**Available for:** Windows (.exe installer, x64) and macOS (.dmg, Intel x64 + Apple Silicon arm64)

This release keeps the v1.31.6 cumulative desktop description and adds the latest CEF, Refresh Prices, and dividend eligibility fixes from June 2, 2026.
...
### Version display
The Help page version display now reports `1.31.7`.

---

## Verification

- Backend dividend eligibility regression tests passed: `py -m unittest backend.test_holdings_manual_edits backend.test_holdings_transactions`
...
- **Windows**: `Portfolio.Tracking.Client.Setup.1.31.7.exe` - NSIS installer, x64
- **macOS**: `Portfolio.Tracking.Client-1.31.7.dmg` and `Portfolio.Tracking.Client-1.31.7-arm64.dmg` - Intel (x64) + Apple Silicon (arm64)

**Cumulative Changelog**: https://github.com/pressj01/portfolio-Tracking-client/compare/v1.29.0...v1.31.7

**Latest Patch Changelog**: https://github.com/pressj01/portfolio-Tracking-client/compare/v1.31.6...v1.31.7
