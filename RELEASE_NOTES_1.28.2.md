# Release Notes — v1.28.2

Release date: May 25, 2026

## Dividend Calculator — Portfolio Source Awareness

- When loading tickers from the portfolio, the Calculation Settings card now shows a read-only **Portfolio Value** summary (e.g., "$25,343 across 21 tickers") instead of the misleading "Initial Investment Per Ticker" input.
...
- When both portfolio and manual tickers are loaded (mixed mode), the global field is relabeled to "Initial Investment (manual tickers only)" with a note showing the portfolio total.
...
- The hero summary line and "Starting Wealth" result stat update dynamically based on whether the tickers come from the portfolio.
...
- `PortfolioTrackingClient-Win-1.28.2.zip`
- `PortfolioTrackingClient-Mac-1.28.2.zip`
