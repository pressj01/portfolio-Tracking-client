...
export function computeHoldingsTableTotals(rows, {
  ...
  return {
    ...
    monthly_income_reinvested: sum('monthly_income_reinvested'),
    monthly_income_not_reinvested: sum('monthly_income_not_reinvested'),
    drip_shares_monthly: sum('drip_shares_monthly'),
    drip_shares_yearly: sum('drip_shares_yearly'),
    current_month_income: sum('current_month_income'),
