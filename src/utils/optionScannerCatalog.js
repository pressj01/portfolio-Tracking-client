export const OPTION_SCANNER_GROUPS = [
  ...
  },
  {
    ...
    scanners: [
      ...
      {
        key: 'fourteen-day-aic',
        label: '14-Day AIC',
        screenLabel: '14-Day Asymmetrical Iron Condor Scanner',
        route: '/fourteen-day-aic-scanner',
        stance: 'Neutral, slightly long',
        risk: 'Defined by structure',
        description: 'Scan Amy Meissner’s 14-day asymmetrical iron condor: 30–35 DTE entry, 14-day hold, built-in put hedge.',
      },
      {
        key: 'monthly-aic',
        label: 'Monthly AIC',
        screenLabel: 'Monthly Asymmetrical Iron Condor Scanner',
        route: '/monthly-aic-scanner',
        stance: 'Neutral, slightly long',
        risk: 'Defined by structure',
        description: 'Scan the monthly AIC/Weirdor: 40–50 DTE entry, exit near 14 DTE remaining, same hedged condor structure.',
      },
