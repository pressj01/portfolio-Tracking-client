    ...
    <div id="put-scanner-help" className="help-box" style={{
      ...
      <HelpSection title="Earnings handling">
        <p style={{ margin: 0 }}>
          ...
          merely flagged. When a candidate has a report coming, the scanner first looks for a <em>different</em>
          expiration inside your DTE window that closes before it, with a few days&rsquo; buffer &mdash; usually stepping
          down to a shorter-dated contract. Only if nothing can clear the date is the candidate dropped (with
          <strong> Skip earnings inside trade</strong> on, the default). The Earnings column shows days until the next
          report and whether the suggested expiration clears it. ETFs read &ldquo;no earnings&rdquo; because a fund has none.
        </p>
      </HelpSection>
      ...
      <HelpSection title="Warnings">
        <Glossary items={[
          ...
          ['Earnings in trade', 'A report lands before the put expires and no expiration could dodge it.'],
  ...
  return (
    <div className="page-container" style={{ maxWidth: 1800, margin: '0 auto', padding: '1.5rem' }}>
      ...
      <div style={{
        ...
        {numField('Target DTE', 'target_dte', { width: 65, tip: 'Preferred days to expiration for the suggested put' })}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
          ...
          {filters.include_stocks && checkField('Skip earnings inside trade', 'exclude_earnings_before_expiry', 'Stocks only — ETFs have no earnings report')}
                        ...
                        {r.put ? (
                          <div style={{
                            ...
                            <div style={{ fontSize: '0.68rem', color: 'var(--text-muted)', whiteSpace: 'nowrap' }}>
                              exp {r.put.expiration} · {r.put.dte}d
                            </div>
