...
const COLUMNS = [
  ...
  { key: 'name', label: 'Fund Name', wide: true },
  {
    ...
    fmt: signedPct,
    sign: true,
    title: 'Price Appreciation: (final split-adjusted market price ÷ starting price) − 1. Distributions are excluded.',
  },
  {
    key: 'nav_annual',
    label: 'Price CAGR',
    fmt: signedPct,
    sign: true,
    title: 'Price CAGR: the annualized price-only return from the starting split-adjusted market price to the final price. Distributions are excluded; this is not official fund NAV.',
  },
  {
    key: 'tr_full',
    label: 'Full DRIP TR',
    fmt: signedPct,
    sign: true,
    title: 'Full DRIP Total Return: ((final shares after reinvesting 100% of distributions × final price) ÷ initial investment) − 1. No distribution cash is held separately.',
  },
  {
    key: 'tr_50',
    label: '50% DRIP TR',
    fmt: signedPct,
    sign: true,
    title: '50% DRIP Total Return: (((final shares after reinvesting 50% of each distribution × final price) + retained cash grown at the Cash rate) ÷ initial investment) − 1.',
  },
  {
    key: 'tr_none',
    label: 'No DRIP TR',
    fmt: signedPct,
    sign: true,
    title: 'No DRIP Total Return: (((initial shares × final price) + all distributions held as cash and grown at the Cash rate) ÷ initial investment) − 1.',
  },
