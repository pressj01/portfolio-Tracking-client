# Portfolio Tracking Client v1.33.8
...
v1.33.6 was prepared but never published, so everything described for it is included here and is new to anyone coming from v1.33.5. v1.33.8 corrects the realized total on the Option Trades summary, which reported only the current year while every other card on it counted every trade.
