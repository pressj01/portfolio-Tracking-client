# Portfolio Tracking Client v1.33.5

Desktop installers are available for Windows PC, Intel Mac, and Apple-silicon Mac.

This release carries forward everything shipped after v1.32.1 and adds the cost-basis correctness fixes and the realized-position views below. The Windows installer is code signed.
...
**Full Changelog**: https://github.com/pressj01/portfolio-Tracking-client/compare/v1.32.1...v1.33.5
