# Portfolio Tracking Client v1.31.13
...
Download **`Portfolio.Tracking.Client.Setup.1.31.13.exe`** and run the NSIS installer.
...
- **`Portfolio.Tracking.Client-1.31.13-arm64.dmg`** — Apple Silicon (M1, M2, M3, M4, and later).
- **`Portfolio.Tracking.Client-1.31.13.dmg`** — Intel x64 Macs.
...
- GitHub Actions builds the Windows and macOS installers independently from the `v1.31.13` tag.
...
- [All commits from v1.31.12 to v1.31.13](https://github.com/pressj01/portfolio-Tracking-client/compare/v1.31.12...v1.31.13)
