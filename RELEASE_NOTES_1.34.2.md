# Portfolio Tracking Client v1.34.2
...
- A manually locked payout frequency now controls annual-income estimates during market refreshes, so weekly holdings no longer retain a monthly annualization.
...
**Full Changelog**: https://github.com/pressj01/portfolio-Tracking-client/compare/v1.34.1...v1.34.2
