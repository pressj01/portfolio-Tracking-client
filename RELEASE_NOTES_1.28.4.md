...
- `PortfolioTrackingClient-Win-1.28.4.zip`
- `PortfolioTrackingClient-Mac-1.28.4.zip`
- `Portfolio.Tracking.Client.Setup.1.28.4.exe`
- `Portfolio.Tracking.Client-1.28.4.dmg`
- `Portfolio.Tracking.Client-1.28.4-arm64.dmg`
